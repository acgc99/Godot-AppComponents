...
void ACTransitionControl::_transit_vanish(){
    _create_tween();
    tween->tween_property(this, "modulate:a", 0.0, duration)->set_ease(ease)->set_trans(transition);
}


void ACTransitionControl::_transit_translate_left(){
    _create_tween();
    tween->tween_property(this, "position:x", -get_size().x, duration)->set_ease(ease)->set_trans(transition);
}
...
void ACTransitionControl::_transit_translate_left_up(){
    _create_tween();
    tween->tween_property(this, "position:x", -get_size().x, duration)->set_ease(ease)->set_trans(transition);
    tween->parallel()->tween_property(this, "position:y", -get_size().y, duration)->set_ease(ease)->set_trans(transition);
}


void ACTransitionControl::_transit_translate_up(){
    _create_tween();
    tween->tween_property(this, "position:y", -get_size().y, duration)->set_ease(ease)->set_trans(transition);
}
...
void ACTransitionControl::_transit_shrink_left(){
    _create_tween();
    tween->tween_property(this, "scale:x", 0.0, duration)->set_ease(ease)->set_trans(transition);
}
...
void ACTransitionControl::_transit_shrink_left_up(){
    _create_tween();
    tween->tween_property(this, "scale:x", 0.0, duration)->set_ease(ease)->set_trans(transition);
    tween->parallel()->tween_property(this, "scale:y", 0.0, duration)->set_ease(ease)->set_trans(transition);
}


void ACTransitionControl::_transit_shrink_up(){
    _create_tween();
    tween->tween_property(this, "scale:y", 0.0, duration)->set_ease(ease)->set_trans(transition);
}
...
void ACTransitionControl::_transit_shrink_right_up(){
    _create_tween();
    tween->tween_property(this, "scale:x", 0.0, duration)->set_ease(ease)->set_trans(transition);
    tween->parallel()->tween_property(this, "position:x", get_size().x, duration)->set_ease(ease)->set_trans(transition);
    tween->parallel()->tween_property(this, "scale:y", 0.0, duration)->set_ease(ease)->set_trans(transition);
}
...
void ACTransitionControl::_transit_shrink_center(){
    _create_tween();
    tween->tween_property(this, "scale:x", 0.0, duration)->set_ease(ease)->set_trans(transition);
    tween->parallel()->tween_property(this, "position:x", get_size().x/2.0, duration)->set_ease(ease)->set_trans(transition);
    tween->parallel()->tween_property(this, "scale:y", 0.0, duration)->set_ease(ease)->set_trans(transition);
    tween->parallel()->tween_property(this, "position:y", get_size().y/2.0, duration)->set_ease(ease)->set_trans(transition);
}
...
void ACTransitionControl::_create_tween(){
    _reset_properties();
    tween = create_tween();
    tween->connect("finished", Callable(this, "_on_tween_finished"));
}
...
void ACTransitionControl::set_duration(const double duration){
...
void ACTransitionControl::set_animation(const ACTransitionControl::Animation animation){
...
void ACTransitionControl::set_ease(const Tween::EaseType ease){
    this->ease = ease;
}
...
void ACTransitionControl::set_transition(const Tween::TransitionType transition){
...
void ACTransitionControl::set_initial_alpha(const double initial_alpha){
...
void ACTransitionControl::set_initial_position(const Vector2 initial_position){
...
void ACTransitionControl::set_initial_scale(const Vector2 initial_scale){
